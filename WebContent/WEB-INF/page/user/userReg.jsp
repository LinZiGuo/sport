...
<link href="${pageContext.request.contextPath}/css/global/header.css" rel="stylesheet" type="text/css">
<link href="${pageContext.request.contextPath}/css/global/reg.css" rel="stylesheet" type="text/css">
<SCRIPT language=JavaScript src="${pageContext.request.contextPath}/js/FoshanRen.js"></SCRIPT>
<SCRIPT language=JavaScript src="${pageContext.request.contextPath}/js/xmlhttp.js"></SCRIPT>
  <SCRIPT LANGUAGE="JavaScript">
	...
	function checkUsername(){
		...
		'/user/isUserExist?username='+ username, true);
	}
  </SCRIPT>
</head>
...
<TABLE cellSpacing=0 cellPadding=0 width=770 align=center border=0>
  <TBODY>
  <TR><TD background="${pageContext.request.contextPath}/images/login/login_03.jpg">&nbsp;</TD></TR>
  <TR>
    <TD height=15>&nbsp;</TD>
  </TR>
  <TR>
    <TD height=30><img src="${pageContext.request.contextPath}/images/login/zc.gif" width="128" height="31" /></TD>
  </TR>
 </TBODY>
</TABLE>
...
<TABLE cellSpacing=1 cellPadding=8 width="78%" align="center" bgColor="#dd9988" border=0>
  <TBODY>
  <TR>
    <TD bgColor="#ffffd5" align="left"><IMG height="17" src="${pageContext.request.contextPath}/images/buy/exclamation-error-red.gif" width="17"> <FONT color="#990000"><STRONG><SPAN class="font14">错误提示<BR></SPAN></STRONG></FONT>
...
<div id="Content">
<s:form action="reg" method="post" onsubmit="javascript:return checkForm()">
