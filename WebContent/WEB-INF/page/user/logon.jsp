...
<s:form action="/user/logon" method="post" onsubmit="javascript:return checkForm()">
					...
					<tr>
						<td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
								<tr>
									...
									<td width="8%" align="left" valign="middle"><input type="image" name="ImageButton1" src="/images/global/regloginbutton2.jpg" alt="" border="0" onClick="this.form.submit()"/>&nbsp;</td>
