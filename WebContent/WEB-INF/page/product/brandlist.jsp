...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="/control/brand/manage/editUI?code=${entry.code}">
    ...
    <tr> 
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              <td width="85%">
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='/control/brand/manage/addUI'" value="添加品牌"> &nbsp;&nbsp;
			  <input name="query_button" type="button" class="frm_btn" id="query" onClick="javascript:window.location.href='/control/brand/manage/queryUI'" value=" 查 询 "> &nbsp;&nbsp;
            </td>
          </tr>
        </table></td>
    </tr>
