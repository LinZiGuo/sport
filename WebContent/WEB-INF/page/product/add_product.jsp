...
<form action="/control/product/manage/add" enctype="multipart/form-data" method="post">
<input name="typeid" type="hidden">
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%">
      <input name="baseprice" type="text" size="10" maxlength="10" onkeypress="javascript:InputLongNumberCheck()"> 元 <font color="#FF0000">*</font></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">市场价 ：</div></td>
      <td width="75%">
      <input name="marketprice" type="text" size="10" maxlength="10" onkeypress="javascript:InputLongNumberCheck()"> 元 <font color="#FF0000">*</font></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">销售价 ：</div></td>
      <td width="75%">
      <input name="sellprice" type="text" size="10" maxlength="10" onkeypress="javascript:InputLongNumberCheck()"> 元 <font color="#FF0000">*</font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
	...
	<tr bgcolor="f5f5f5"> 
      ...
      <td width="75%"><s:select name="sex" list="#{'MAN':'男士','WOMEN':'女士' }" headerKey="NONE" headerValue="男女不限"></s:select></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">型号 ：</div></td>
      <td width="75%"><input name="model" type="text" size="35" maxlength="30"></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">重量 ：</div></td>
      <td width="75%"><input name="weight" type="text" size="10" maxlength="10" onkeypress="javascript:InputIntNumberCheck()"> 克</td>
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td width="25%"> <div align="right">购买说明 ：</div></td>
      <td width="75%"><input name="buyexplain" type="text" size="35" maxlength="30"></td>
    </tr>
	<tr bgcolor="f5f5f5"> 
