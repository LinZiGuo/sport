...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="/control/product/type/manage/editUI?typeid=${entry.typeid }">
	  <img src="/images/edit.gif" width="15" height="16" border="0"></a></div></td>
      <td bgcolor="f5f5f5">
      	<div align="center">
	      	<a href="/control/product/type/list?parentid=${entry.typeid }">${entry.name }</a>
			<c:if test="${fn:length(entry.childtypes)>0}">
			${fn:length(entry.childtypes)}
				<font color=red>(有${fn:length(entry.childtypes)}个子类)</font>
			</c:if>
		</div>
	  </td>
	  <td bgcolor="f5f5f5"> <div align="center"><a href="/control/product/type/manage/addUI?parentid=${entry.typeid}">创建子类别</a></div></td>
    ...
    <tr> 
      <td bgcolor="f5f5f5" colspan="6" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              <td width="85%">
              <input name="AddDic" type="button" class="frm_btn" id="AddDic" onClick="javascript:window.location.href='/control/product/type/manage/addUI?parentid=${param.parentid}'" value="添加类别"> &nbsp;&nbsp;
			  <input name="query" type="button" class="frm_btn" id="query" onClick="javascript:window.location.href='/control/product/type/manage/queryUI'" value=" 查 询 "> &nbsp;&nbsp;
            </td>
          </tr>
        </table></td>
    </tr>
